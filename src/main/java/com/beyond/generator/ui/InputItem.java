 ...
 * @date 2021/02/22
 */
public class InputItem implements FormItem {
    ...
    public InputItem(String bindName) {
        this(bindName, null);
    }

    public InputItem(String bindName, String labelText) {
        this(bindName, labelText, null);
    }

    public InputItem(String bindName, String labelText, String defaultValue) {
        this(bindName, labelText, defaultValue, null);
    }


    public InputItem(String bindName, String labelText, String defaultValue, Runnable runnable) {
