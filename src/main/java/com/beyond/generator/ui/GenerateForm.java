...
public class GenerateForm extends DialogWrapper {
    ...
    protected @Nullable JComponent createCenterPanel() {
        return form.addItem(new InputItem("jdbcUrl", "jdbcUrl: ", getProperty("jdbcUrl", project)))
                ...
                .addItem(new InputItem("withDefaultValue", "withDefaultValue: ", getProperty("withDefaultValue", project)))
                .buildPanel(14, 2);
    }
    ...
    private void saveFormProperties() {
        ...
        saveProperty("withDefaultValue", getData().get("withDefaultValue"), true, project);
